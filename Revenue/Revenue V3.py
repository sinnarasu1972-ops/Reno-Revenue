...
function buildCompParams() {
    const p = new URLSearchParams();
    ["c-division","c-service","c-sa","c-invoice"].forEach(key => {
...
async function loadComparison() {
    ...
    try {
        ...
        // Totals
        const tot = { i24:0, i25:0, l24:0, l25:0, s24:0, s25:0 };
        rows.forEach(r => {
        ...
        function buildTable(title, cy24key, cy25key, pctKey, isCurrency) {
            ...
            else { tot24=tot.s24; tot25=tot.s25; totPct=totSPct; }
